...
\addcontentsline{toc}{subsection}{2. Systemlandkarte mit Sollkonzept}
...
Allgemein kann man sagen, dass alle \glqq{Standard\grqq -Daten, also Daten wie verfügbares Geld, Personalstärke und Lagerstand, in die Datenbank abgelegt werden sollten damit diese von den Abteilungen genutzt werden können. 
...
ERP-Systeme sind modular aufgebaut und somit an einzelne Kunden besser individuell anpassbar. Moderne ERP-Systeme umfassen oft eine große Zahl an Funktionsbereichen oder Modulen. Da die ERP-Systeme von SAP in Deutschland am weitesten verbreitet sind\cite{Foerster2008}, haben wir uns beschlossen die Module von SAP/R3 als Module eines typischen ERP-Systems aus dem Unternehmenskontext zu sehen. Für die Polizei Bremen wären also folgende Module relevant: 

\vspace{0,5cm}

Financial, Controlling, Material Management, Production Planning and Control, Workflow, Enterprise Content Management, Quality Management, Plant Maintenance, Human Capital Management, Business Intelligence, Employee Self-Service, Manager Self-Service, Project Systems, Industry Solutions (Public Sector)\cite{SAPModule} Außerdem gibt es speziell für Fuhrparks eine von SAP zertifizierte Lösung namens \glqq fleet 3.0\grqq , die sich problemlos in ein bestehendes ERP-System von von SAP integrieren lässt\cite{fleet3.0}. 

\vspace{0,5cm}

Mit diesen Modulen lassen sich nach einigem Customizen und an die Anforderungen Anpassen alle der bisherigen Funktionen der existierenden Softwaresysteme und Datenbanken und noch ein paar weitere in das ERP-System integrieren. 

Financial wäre für das Rechnungswesen und für die Budgetverwaltung zuständig, Controlling dafür, um das Management oder die höheren Positionen wie die Einsatzleitung bei ihren Entscheidungen zu unterstützen. Die Material- und Fundsachenverwaltung und der Einkauf werden von Material Management übernommen. Die Personalverwaltung und Bewerbungsverwaltung übernimmt das Modul Human Capital Management. Für das Reviermanagement könnte das Modul Production Planning and Control zuständig sein. Alle anderen Module sind für die Optimierung der alltäglichen Prozesse oder Projekte verantwortlich\cite{SAPModule}.

\subsection*{4. Einführung eines ERP-Systems}
\addcontentsline{toc}{subsection}{4. Einführung eines ERP-Systems}
